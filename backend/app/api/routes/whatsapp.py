...
@router.get("/integrations/whatsapp/config", response_model=WhatsAppConfigurationResponse)
...
@router.put("/integrations/whatsapp/config", response_model=WhatsAppConfigurationResponse)
...
@router.post("/integrations/whatsapp/test", response_model=WhatsAppTestResponse)
