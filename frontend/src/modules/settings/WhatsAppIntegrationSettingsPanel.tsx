  ...
  return <article className="panel integration-card integration-card-expanded">
    ...
    <div className="smtp-config-panel">
      <div className="form-grid smtp-config-grid">
        ...
        <label className="field"><span>WhatsApp Business Account ID</span><input disabled={!canEdit} placeholder="WABA ID" value={config.business_account_id} onChange={e=>setConfig(current=>({...current,business_account_id:e.target.value}))}/></label>
        <label className="field"><span>Phone Number ID</span><input disabled={!canEdit} placeholder="ID do número na Meta" value={config.phone_number_id} onChange={e=>setConfig(current=>({...current,phone_number_id:e.target.value}))}/></label>
