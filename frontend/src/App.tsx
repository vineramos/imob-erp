...
const devUser: CurrentUser = {
  ...
  permissions: [
    ...
    'inspections.manage', 'maintenance.manage', 'agenda.manage', 'reports.export',
...
function ErpApp() {
  ...
  const implemented = ['dashboard', 'people', 'properties', 'brokers', 'captures', 'crm', 'contracts', 'inspections', 'maintenance', 'finance', 'agenda', 'reports', 'settings']
